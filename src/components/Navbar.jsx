...
const Navbar = () => {
  ...
  const links = (
    <>
      ...
      <li>
        <NavLink to="/jobs" className="text-base font-bold">
          Applied Jobs
        </NavLink>
      </li>
      <li>
        <NavLink to="/blogs" className="text-base font-bold">
          Blog
        </NavLink>
      </li>
    </>
  ...
  return (
    <div className="navbar bg-base-100 shadow-lg fixed z-10 mt-0">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost gap-0 text-2xl md:text-3xl font-extrabold">
      ...
      <div className="navbar-end gap-2">
        ...
        <a className="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 md:font-medium border-primary  text-white">
